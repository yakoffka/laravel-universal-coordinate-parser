...
class Pattern09Test extends TestCase
{
     ...
     * @return void
     *
     * docker compose exec php php artisan test --filter pattern09Success
     ...
     * @return void
     *
     * docker compose exec php php artisan test --filter pattern09WrongLatitude
     * @throws WrongLatitudeException
     * @throws WrongLetterException
     * @throws WrongLongitudeException
     */
     ...
     * @return void
     *
     * docker compose exec php php artisan test --filter pattern09WrongLongitude
     * @throws WrongLatitudeException
     * @throws WrongLetterException
     * @throws WrongLongitudeException
     */
